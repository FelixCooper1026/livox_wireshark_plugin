...
支持 **Avia2, Mid-360S, Mid-360, HAP, Avia, Horizon, Tele-15, Mid-70, Mid-40** 等产品的数据解析，包括 **推送消息、点云数据、IMU 数据以及控制指令帧** 的解析。
...
- **2026-04-24**: 优化 Wireshark 3.x版本兼容性，将位运算符&和>>替换为bit.band/bit.rshift
- **2026-04-17**: 增加 Mid-360S 电机转速控制和异常时间过滤字段，增加 0x0118 故障码
- **2026-02-03**: 增加 Avia2 推送信息相关字段支持
